...
/* platform data begin */
/* 6885 begin */
#define SIZE_6885_TOP (sizeof(mt6885_top_data) / sizeof(struct fh_pll_data))
...
static struct fh_pll_domain mt6885_top = {
	.name = "top",
	.data = mt6885_top_data,
	.offset = mt6885_top_offset,
	.regs = mt6885_top_regs,
	.init = &init_v1,
};
